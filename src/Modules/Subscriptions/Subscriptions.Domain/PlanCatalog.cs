...
public sealed record PlanInfo(PlanTier Tier, string Nome, int LimiteFiliais, int LimiteUsuarios, decimal PrecoMensal, string? StripePriceId);
...
public static class PlanCatalog
{
    ...
    {
        // LimiteUsuarios espelha a landing (auditoria pré-venda — "Até 3 usuários"/"Usuários
        // ilimitados" eram só texto até aqui, sem checagem nenhuma no backend).
        [PlanTier.Starter] = new PlanInfo(PlanTier.Starter, "Starter", LimiteFiliais: 1, LimiteUsuarios: 3, PrecoMensal: 129m, StripePriceId: null),
        [PlanTier.Profissional] = new PlanInfo(PlanTier.Profissional, "Profissional", LimiteFiliais: 3, LimiteUsuarios: int.MaxValue, PrecoMensal: 349m, StripePriceId: null),
        ...
        [PlanTier.Rede] = new PlanInfo(PlanTier.Rede, "Rede", LimiteFiliais: int.MaxValue, LimiteUsuarios: int.MaxValue, PrecoMensal: 0m, StripePriceId: null),
    };
